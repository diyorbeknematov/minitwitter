...
const (
	...
	MediaService_GetMedias_FullMethodName   = "/media.MediaService/GetMedias"
...
func (c *mediaServiceClient) GetMedias(ctx context.Context, in *GetMediasRequest, opts ...grpc.CallOption) (*GetMediasResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMediasResponse)
	err := c.cc.Invoke(ctx, MediaService_GetMedias_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMediaServiceServer) GetMedias(context.Context, *GetMediasRequest) (*GetMediasResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMedias not implemented")
}
...
func _MediaService_GetMedias_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediaService_GetMedias_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaServiceServer).GetMedias(ctx, req.(*GetMediasRequest))
	}
	return interceptor(ctx, in, info, handler)
}
